...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            case 'required_conn':
                ...
                if ($result->num_rows > 0) {
                    ...
                    elseif ($remove_quantity > $current_availableqty) {
                        ...
                        $message = "Are you sure you want to issue <strong>$remove_quantity</strong> connectors of part number <strong>$part_no</strong> from <strong>$req_make</strong> to <strong>$issue_name</strong>?";
                        $show_confirmation = true;
                    }
                }
                break;
    ...
    if (isset($_POST['confirm'])) {
            ...
            case 'required_conn':
                ...
                if ($result->num_rows > 0) {
                    ...
                    if ($conn->query($sql) === TRUE) {
                        ...
                        $issue_sql = "INSERT INTO issue (Nomenclature, make, issuedqty, person_name, timestamp) 
                        VALUES ('$part_no', '$make', $remove_quantity, '$issue_name', NOW())";
                            ...
                            $_SESSION['alert'] = [
                                ...
                                'message' => "Issued <strong>$remove_quantity</strong> connectors of part number: <strong>$part_no</strong> from <strong>$make</strong><br>"
                                      ...
                                      . "Issued to: <strong>$issue_name</strong>"
                            ];
                        } else {
                            $_SESSION['alert'] = [
                                'type' => 'error',
        ...
        // Clear session data
        unset($_SESSION['form_type'], $_SESSION['Nomenclature'], $_SESSION['make'], $_SESSION['quantity'], $_SESSION['add_quantity'], $_SESSION['remove_quantity'], $_SESSION['issue_name']);
...
<body>
    ...
    <div class="alert-box alert-<?php echo $_SESSION['alert']['type']; ?>" style="display: block;">
        <?php if ($_SESSION['alert']['type'] == 'success'): ?>
            <img src="verified.gif" alt="Success" class="alert-gif">
        <?php elseif ($_SESSION['alert']['type'] == 'error'): ?>
            <img src="alarm (1).gif" alt="Error" class="alert-gif">
        <?php elseif ($_SESSION['alert']['type'] == 'warning'): ?>
            <img src="alarm.gif" alt="Warning" class="alert-gif">
        <?php endif; ?>
